...
'''
This code is modified from google's documentation at https://developers.google.com/youtube/v3/guides/uploading_a_video
'''
...
if __name__ == '__main__':
    arg_dict = {'--file': 'joke10.mp4'}
    upload_video(arg_dict)
